      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <a target="_blank" rel="noopener" class="link" href="https://github.com/saadeghi/dcui/discussions">{$t("ask the community")}</a>
          </div>
        </div>
        <div class="flex items-center gap-2">
          ...
          <div>
            {$t("Do you see a bug?")}
            <a target="_blank" rel="noopener" class="link" href={`https://github.com/saadeghi/dcui/issues?q=${arrayOfPagesInOrder[currentPageIndex].name}`}>{$t("open an issue on GitHub")}</a>
          </div>
        </div>
        <div class="flex items-center gap-2">
          ...
          <div>
            ...
            <a target="_blank" rel="noopener" class="link" href={`https://twitter.com/intent/tweet?text=daisyUI%20%0D%0AComponents%20for%20Tailwind%20CSS%20%0D%0Ahttps://dcui.com`}>{$t("tweet about it!")}</a>
          </div>
        </div>
      </div>
      <div class="flex flex-col gap-2">
        <div class="flex items-center gap-2">
          ...
          <div>
            <a target="_blank" rel="noopener" class="link" href={`https://github.com/saadeghi/dcui/blob/master/src/docs/src/routes${$page.url.pathname.replace(/\/$/, "")}.svelte.md?plain=1`}>{$t("Edit this page on GitHub")}</a>
          </div>
        </div>
        {#if $currentLang != defaultLang}
          <div class="flex items-center gap-2">
            ...
            <div>
              <a target="_blank" rel="noopener" class="link" href={`https://github.com/saadeghi/dcui/blob/master/src/docs/src/translation/${$currentLang}.json`}>{$t("Contribute to translation")}</a>
            </div>
          </div>
        {/if}
      </div>
